...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `test`.`contact`(`name`, `mail`, `PhoneNumber`) VALUES ('$name', '$mail', '$PhoneNumber')";
     echo $sql;
            ...
            <div id="about">
                ...
                <div class="partner">
                    ...
                    <div class="thumb">
                        ...
                        <div class="thumb-box">
                            <img class="lazy" src="" data-src="partner3.jpg" alt="">
                            <h3>Senior Agent</h3>
                            <div class="social">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-instagram"></i></a>
            ...
            <div id="contact">
                ...
                <div class="content">
                    <form  action="connect.php" method="post">
                        ...
                        required placeholder="PhoneNumber">
                        <textarea name="mess" id="mess" rows="7"
                        placeholder="Your Message Here..."></textarea>
                        <input type="textarea" name="mess" id = "mess" require>
